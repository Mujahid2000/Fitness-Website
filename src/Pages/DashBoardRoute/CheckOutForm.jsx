...
const CheckOutForm = ({ salary, trainerId, name }) => {
    ...
    useEffect(() => {
        const handlePaymentIntent = async () => {
            try {
                ...
                const response = await axios.post('https://fitness-server-seven.vercel.app/create-payment-intent', {
                    price: parsedSalary,
                    trainerId
                });
    ...
    const handleSubmit = async (event) => {
        ...
        if(confirmError){
            ...
            const res = await axios.post('https://fitness-server-seven.vercel.app/payments', payment);
