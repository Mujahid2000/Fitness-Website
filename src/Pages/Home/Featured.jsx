...
const Featured = () => {
  ...
  {feature.map((featured) => (
    <div key={featured.id} className={`max-w-sm hover:scale-105 transition-transform duration-300 rounded-lg shadow bg-blue-300 dark:bg-gray-800 dark:border-gray-700`}>
      <a href="#">
        <img className="rounded-t-lg h-64 w-full" src={featured.image} alt="" />
      </a>
      <div className="p-5">
        <a href="#">
          <h5 className="mb-2 text-lg lg:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{featured.title}</h5>
        </a>
