    ...
    return (
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <a href="https://flowbite.com/" className="hover:underline">Address: Dhanmondi, Dhaka</a>
                </li>
                <li>
                    <a href="https://tailwindcss.com/" className="hover:underline">Tel: +82547169</a>
                </li>
            </ul>
        </div>
        <div>
        ...
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">Fitness Center™</a>. All Rights Reserved.
        </span>
