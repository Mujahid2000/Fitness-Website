...
const MyFooter = () => {
    return (
        <div>
        <footer className="bg-gray-800 border rounded-t-sm rounded-b-xl mt-5">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <a href="/" className="hover:underline text-white">Address: Dhanmondi, Dhaka</a>
                </li>
                <li>
                    <a href="/" className="hover:underline text-white">Tel: +82547169</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li>
                    <a href="" className="hover:underline text-white">Youtube</a>
                </li>
            </ul>
        </div>
        <div>
        ...
        <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">Fitness Center™</a>. All Rights Reserved.
        </span>
        ...
        <a href="#" className="text-gray-500 hover:text-white dark:hover:text-white ms-5">
            <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 21 16">
            ...
            <span className="sr-only text-white">YouTube</span>
        </a>
        <a href="#" className="text-gray-500 hover:text-white dark:hover:text-white ms-5">
