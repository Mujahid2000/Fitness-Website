...
const GymSchedule = () => {
  ...
  useEffect(() => {
    Axios.get('https://fitness-server-seven.vercel.app/weeklySchedule')
                ...
                className={`absolute top-full left-0 z-10 ${isDropdownOpen ? 'block' : 'hidden'} bg-black divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
                  ...
                  <button
                    ...
                    className={`inline-flex w-full px-4 py-2 ${
                      !selectedCategory ? 'bg-gray-200 dark:bg-gray-600 dark:text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white'
                    }`}
